...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./DiffIR/weights/RealworldSR-DiffIRS2x4.pth')
    ...
    for name in im_list:
        ...
        save_path = os.path.join(args.res_path, name.split('.')[0]+f'_out-{args.scale}x.png')
